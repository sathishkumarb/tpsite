...
return array(
    'router' => array(
        'routes' => array(
            ...
            'uniqueemail' => array(
                'type' => 'Literal',//segment - changed
                'options' => array(
                    'route' => '/index/checkemail',///[:email]
                    'defaults' => array(
                        'controller' => 'Application\Controller\Index',
                        'action' => 'checkemail',
                    ),
            ...
            'eventimageupload' => array(
                'type' => 'segment',
                'options' => array(
                    'route' => '/events/frontendeventimageupload',
                    'defaults' => array(
                        'controller' => 'Application\Controller\Event',
                        'action' => 'frontendeventimageupload',
                    ),
                ),
            ),
            'eventadd' => array(
                'type' => 'segment',
                'options' => array(
                    'route' => '/events/frontendadd',
                    'defaults' => array(
                        'controller' => 'Application\Controller\Event',
                        'action' => 'frontendeventadd',
                    ),
                ),
            ),
            'eventprocessadd' => array(
                'type' => 'segment',
                'options' => array(
                    'route' => '/events/frontendeventaddprocess',
                    'defaults' => array(
                        'controller' => 'Application\Controller\Event',
                        'action' => 'frontendeventaddprocess',
                    ),
                ),
            ),
            'eventsearch' => array(
            ...
            'eventday' => array(
                'type' => 'segment',
                'options' => array(
                    'route' => '/eventsday/[:type]/[:searchval]',
                    'defaults' => array(
                        'controller' => 'Application\Controller\Event',
                        'action' => 'eventday',
                    ),
			...
			'sendticketemail' => array(
                'type' => 'segment',
                'options' => array(
                    'route' => '/user/sendticketemail',
                    'defaults' => array(
                        'controller' => 'Application\Controller\User',
