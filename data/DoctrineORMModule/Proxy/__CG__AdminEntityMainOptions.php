 ...
 */
class MainOptions extends \Admin\Entity\MainOptions implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Admin\\Entity\\MainOptions' . "\0" . 'id', '' . "\0" . 'Admin\\Entity\\MainOptions' . "\0" . 'name', '' . "\0" . 'Admin\\Entity\\MainOptions' . "\0" . 'icon', '' . "\0" . 'Admin\\Entity\\MainOptions' . "\0" . 'createdDate');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MainOptions $proxy) {
