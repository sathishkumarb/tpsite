 ...
 */
class UserRole extends \Admin\Entity\UserRole implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Admin\\Entity\\UserRole' . "\0" . 'id', '' . "\0" . 'Admin\\Entity\\UserRole' . "\0" . 'roleName', '' . "\0" . 'Admin\\Entity\\UserRole' . "\0" . 'createdDate', '' . "\0" . 'Admin\\Entity\\UserRole' . "\0" . 'updatedDate', '' . "\0" . 'Admin\\Entity\\UserRole' . "\0" . 'status');
        }
