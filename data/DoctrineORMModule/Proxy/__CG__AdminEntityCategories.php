...
class Categories extends \Admin\Entity\Categories implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Admin\\Entity\\Categories' . "\0" . 'id', '' . "\0" . 'Admin\\Entity\\Categories' . "\0" . 'categoryName', '' . "\0" . 'Admin\\Entity\\Categories' . "\0" . 'icon', '' . "\0" . 'Admin\\Entity\\Categories' . "\0" . 'status', '' . "\0" . 'Admin\\Entity\\Categories' . "\0" . 'isDeleted', '' . "\0" . 'Admin\\Entity\\Categories' . "\0" . 'createdDate', '' . "\0" . 'Admin\\Entity\\Categories' . "\0" . 'modifiedDate');
        }
